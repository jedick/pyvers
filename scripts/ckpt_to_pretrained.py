...
model = PyversClassifier.load_from_checkpoint("/home/pyvers/checkpoints/shuffle2/shuffle_512_10epochs.ckpt")
model.model.save_pretrained("/home/pyvers/DeBERTa-v3-base-mnli-fever-anli-scifact-citint")
